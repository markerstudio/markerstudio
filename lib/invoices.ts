...
// statement and the history backfill). The live Finance view converts per day;
// here a steady average is enough. Keep roughly in step with lib/finance.
const APPROX_USD_ILS = 3.7;
