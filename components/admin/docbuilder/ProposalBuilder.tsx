...
export default function ProposalBuilder({
  ...
  const statusPill = useMemo(() => {
    if (accepted) return <span className="lq-chip lq-chip--green !text-[11px]">Accepted ✓</span>;
    if (sent) return <span className="lq-chip lq-chip--orange !text-[11px]">Sent — awaiting acceptance</span>;
  ...
  return (
    <div className="-mx-4 sm:-mx-6">
      ...
      <div className="sticky top-0 z-40 bg-white/85 backdrop-blur-md border-b border-charcoal/10 px-4 sm:px-6 py-3 flex items-center gap-3 flex-wrap">
        <Link href="/admin/proposals" className="text-sm font-medium text-charcoal-60 hover:text-ink no-underline">← Proposals</Link>
